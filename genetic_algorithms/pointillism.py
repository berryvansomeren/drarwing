...
class Pointillism( common.SimpleGeneticAlgorithmBase ):
    ...
    def __init__(
        ...
        self._target_gradient = common.HSVImageGradient( self._target_image )
        self._color_palette = common.HSVColorPalette( self._target_image )
    ...
    def get_initial_population( self ) -> common.Population:
        blank_image = common.get_blank_image_like( self._target_image, is_hsv = True )
